...
- Edge Case: For cheapest transport endpoint, if Persona Transport cost and HSTC Transport cost is the same then HSTC Transport will be returned for cheapest trasnport
- Edge Case: For cheapest transport endpoint, if days of parking is specified as zero then HSTC Transport will be used. Personal transport requires at least one day of parking. It is assumed that less than one day will be rounded up to a day of parking as storage costs cannot free. 
